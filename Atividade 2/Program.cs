    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            switch(opcao){
                ...
                if(litros1 <=20){
                    double resultado2= resultado1/0.3-resultado1;
                     Console.WriteLine($"você terá que pagar {resultado2}");
                }
                else{
                    double resultado2= resultado1/0.5-resultado1;
                     Console.WriteLine($"você terá que pagar {resultado2}");
                }
                break;
                case 'g':
               ...
               Console.WriteLine("Qual a quantidade de combutivel?");
                ...
                if(litros2 <=20){
                    double resultado2= resultado3/0.4-resultado3;
                     Console.WriteLine($"você terá que pagar {resultado2}");
                }
                else{
                    double resultado2= resultado3/0.6-resultado3;
                     Console.WriteLine($"você terá que pagar {resultado2}");
                }
                break;
            }
